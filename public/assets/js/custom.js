...
(function ($) {
	...
	function booking_form() {
		jQuery("div.booking-tab-menu>div.list-group>button").click(function (e) {
			e.preventDefault();
			jQuery(this).siblings('button.active').removeClass("active");
   ...
   ===========================*/
	...
	jQuery(document).on('submit', 'form.cons-contact-form', function (e) {
		...
		/* sending message */
		jQuery.ajax({
			url: 'https://thewebmax.com/react/logitrago/handlers/phpmailer/mail.php',
